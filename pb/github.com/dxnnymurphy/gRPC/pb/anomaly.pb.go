...
type Metric struct {
	...
	Refreshbool bool                   `protobuf:"varint,3,opt,name=refreshbool,proto3" json:"refreshbool,omitempty"`
...
func (x *Metric) GetRefreshbool() bool {
	if x != nil {
...
var file_anomaly_proto_rawDesc = []byte{
	...
	0x62, 0x6f, 0x6f, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x72, 0x65, 0x66, 0x72,
