...
type Metric struct {
	...
	Refreshbool string                 `protobuf:"bytes,3,opt,name=refreshbool,proto3" json:"refreshbool,omitempty"`
...
func (x *Metric) GetRefreshbool() string {
	if x != nil {
		return x.Refreshbool
	}
	return ""
}

func (x *Metric) GetStop() string {
	if x != nil {
		return x.Stop
	}
	return ""
...
var file_anomaly_proto_rawDesc = []byte{
	...
	0x62, 0x6f, 0x6f, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x62, 0x6f, 0x6f, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x74, 0x6f, 0x70, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x74, 0x6f, 0x70, 0x22, 0x36, 0x0a, 0x0e, 0x41,
